...
### Activate the Cucumber3 App
To activate the app, go to the [Apps](https://app.qase.io/apps?app=cucumber3-reporter) section in your workspace, and click on 'Activate'
